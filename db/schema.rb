...
ActiveRecord::Schema.define(version: 20170406192843) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.index ["umbrella_id"], name: "index_messages_on_umbrella_id", using: :btree
  ...
  create_table "umbrellas", force: :cascade do |t|
    ...
    t.float    "latitude"
    t.float    "longitude"
    t.index ["guest_id"], name: "index_umbrellas_on_guest_id", using: :btree
    t.index ["owner_id"], name: "index_umbrellas_on_owner_id", using: :btree
  end
